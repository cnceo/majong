...
@implementation ClassicPauseLayer
...
-(void)setLevel:(int)level
{
    ...
    _levelLabel.string = [NSString stringWithFormat:NSLocalizedString(@"Level %d", nil),_level + 1];
}
...
{
    [[CCDirector sharedDirector] replaceScene:[LevelScene sceneWithSeason:_season Level:self.level] withTransition:[CCTransition transitionCrossFadeWithDuration:0.5]];
}
